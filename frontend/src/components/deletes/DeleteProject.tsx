...
export const DeleteProject: React.FC<DeleteProjectProps> = ({ projectId, onProjectDeleted, onClose }) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      onProjectDeleted();
      toast.success('Projekt został usunięty!', { position: "bottom-center"});
      onClose();
    }
    catch (error) {
  ...
  return (
    <div className="p-4 md:p-5 text-center">
      ...
      <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Jesteś pewny, że chcesz usunąć ten projekt?</h3>
