...
export const DeleteTask: React.FC<DeleteTaskProps> = ({ taskId, onTaskDeleted, onClose }) => {
  ...
  const handleDelete = async (e: { preventDefault: () => void; }) => {
    ...
    try {
      ...
      onTaskDeleted();
      toast.success('Zadanie zostało usunięte!', { position: "bottom-center"});
      onClose();
    }
    catch (error) {
  ...
  return (
    <div className="p-4 md:p-5 text-center">
      ...
      <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Jesteś pewny, że chcesz usunąć to zadanie?</h3>
