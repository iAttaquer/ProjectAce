...
export const ChangeProject: React.FC<ChangeProjectProps> = ({ project, onProjectUpdated, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full mt-2">
      ...
      <input type="text" name="projectName" id="projectName" placeholder="nazwa projektu"
        value={name}
      ...
      <label htmlFor="description" className="block mb-1 mt-1.5 text-sm font-medium text-gray-900 dark:text-white">Opis projektu</label>
