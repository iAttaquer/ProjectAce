    ...
    <div className="p-3">
      <div className="navbar bg-base-100 bg-opacity-40 rounded-lg">
        <div className="flex-1">
          <a className="btn btn-ghost text-xl -space-x-2">
            <h1 className="project-title1 text-2xl font-bold text-gray-500">
              Project
            </h1>
            <h1 className="project-title2 text-3xl font-bold text-green-500">
              ACE
            </h1>
          </a>
        </div>
            ...
            <div tabIndex={0} role="button" className="btn btn-ghost">
              <div className="h-10 flex justify-center items-center space-x-2">
                ...
                <div className="flex items-center text-md">
                  {loading && (
                    <div className="h-2.5 animate-pulse bg-gray-200 rounded-full dark:bg-gray-700 w-28 "></div>
                  )}
      ...
      <dialog id="settings-modal" className="modal ">
        <div className="modal-box w-fit">
          ...
          <div
            role="tablist"
            className="tabs tabs-bordered bg-transparent tabs-lg"
          >
            <input
              type="radio"
              name="my_tabs_1"
